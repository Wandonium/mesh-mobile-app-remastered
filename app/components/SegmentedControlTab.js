...
const handleTabPress = (index: number, multiple: boolean, selectedIndex: number, onTabPress: Function) => {
  console.log('[SegmentedControlTab.js] - handleTabPress')
  if (multiple) {
    onTabPress(index)
...
const getAccessibilityLabelByIndex = (accessibilityLabels: string[], index: number) =>
  accessibilityLabels && accessibilityLabels.length > 0 && accessibilityLabels[index]
    ? accessibilityLabels[index]
    : undefined

const getTestIdByIndex = (testIDs: string[], index: number) =>
                ...
                return (
                  <TabOption
                    ...
                    tabStyle={[
                      ...
                      index !== 0 && index !== values.length - 1 ? { marginLeft: -1 } : {},
                    ]}
                    activeTabStyle={activeTabStyle}
                    tabTextStyle={[tabTextStyle, { color: theme.primaryBlue }]}
